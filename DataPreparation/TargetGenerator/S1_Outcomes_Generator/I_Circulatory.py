...
################ ICD10: I00-I99                        ##################################################
target_code = 'I0'
target_date_f = [str(i) + '-0.0' for i in range(131270, 131423) if i%2==0]

################ Hypertension                           ##################################################
################ ICD10: I10–I15                         ##################################################
target_code = 'I1'
target_date_f = [str(i) + '-0.0' for i in range(131286, 131295) if i%2==0]

################ Ischemic heart diseases                ##################################################
################ ICD10: I20–I25                         ##################################################
target_code = 'I2'
target_date_f = [str(i) + '-0.0' for i in range(131296, 131307) if i%2==0]

################ Arrhythmias                            ##################################################
################ ICD10: I46-I49                         ##################################################
target_code = 'I3'
target_date_f = [str(i) + '-0.0' for i in range(131346, 131353) if i%2==0]

################ Heart failure                          ##################################################
################ ICD10: I50                             ##################################################
target_code = 'I4'
target_date_f = [str(i) + '-0.0' for i in range(131354, 131355) if i%2==0]

################ Stroke                                 ##################################################
################ ICD10: I60-I61, I63-I64                ##################################################
target_code = 'I5'
target_date_f = [str(i) + '-0.0' for i in range(131360, 131363) if i%2==0] + [str(i) + '-0.0' for i in range(131366, 131369) if i%2==0]

################ Peripheral artery diseases              ##################################################
################ ICD10: I70-I79                         ##################################################
target_code = 'I6'
target_date_f = [str(i) + '-0.0' for i in range(131380, 131395) if i%2==0]
