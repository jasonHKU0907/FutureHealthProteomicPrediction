...
################ ICD10: E00–E90           ##################################################
target_code = 'E0'
target_date_f = [str(i) + '-0.0' for i in range(130690, 130835) if i%2==0]

################ Diabetes                 ##################################################
################ ICD10: E10-E14           ##################################################
target_code = 'E1'
target_date_f = [str(i) + '-0.0' for i in range(130706, 130715) if i%2==0]

################ Obesity                  ##################################################
################ ICD10: E66               ##################################################
target_code = 'E2'
target_date_f = [str(i) + '-0.0' for i in range(130792, 130793) if i%2==0]
