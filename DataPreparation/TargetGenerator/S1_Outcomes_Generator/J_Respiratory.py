...
################ ICD10: J00-I99                        ##################################################
target_code = 'J0'
target_date_f = [str(i) + '-0.0' for i in range(131424, 131551) if i%2==0]

################ chronic obstructive pulmonary disease  ##################################################
################ ICD10: J40-J44, J47                    ##################################################
target_code = 'J1'
target_date_f = [str(i) + '-0.0' for i in range(131484, 131493) if i%2==0] + ['131498-0.0']

################ Asthma                                 ##################################################
################ ICD10: J45-J46                         ##################################################
target_code = 'J2'
target_date_f = [str(i) + '-0.0' for i in range(131494, 131497) if i%2==0]
