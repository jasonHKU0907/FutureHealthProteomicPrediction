...
date_f_lst = ['40005-'+str(i)+'.0' for i in range(22)]
code_f_lst = ['40006-'+str(i)+'.0' for i in range(22)]

cancer_df = pd.read_csv(dpath + 'ukb672277_Cancer_data.csv', usecols = ['eid'] + date_f_lst + code_f_lst)
...
################ ICD10: C00–C97        ##################################################
target_code = 'C0'
target_cancer_f = ['C0'+str(i) for i in range(10)] + ['C'+str(i) for i in range(10, 98)]
...
################ ICD10: C81-C96        ##################################################
target_code = 'C4'
target_cancer_f = ['C'+str(i) for i in range(81, 97)]
'''
