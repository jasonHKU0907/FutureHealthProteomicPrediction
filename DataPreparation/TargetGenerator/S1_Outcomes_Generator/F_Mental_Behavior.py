...
################ ICD10: F00–F99                        ##################################################
target_code = 'F0'
target_date_f = [str(i) + '-0.0' for i in range(130836, 130991) if i%2==0]

################ Dementia                               ##################################################
################ ICD10: F00–F03, G30, G31               ##################################################
target_code = 'F1'
target_date_f = [str(i) + '-0.0' for i in range(130836, 130843) if i%2==0] + [str(i) + '-0.0' for i in range(131036, 131039) if i%2==0]

################ Mood disorders                         ##################################################
################ ICD10: F30–F39                         ##################################################
target_code = 'F4'
target_date_f = [str(i) + '-0.0' for i in range(130890, 130903) if i%2==0]

################ Neurotic_disorders                     ##################################################
################ ICD10: F40–F48                         ##################################################
target_code = 'F5'
target_date_f = [str(i) + '-0.0' for i in range(130904, 130917) if i%2==0]
'''
