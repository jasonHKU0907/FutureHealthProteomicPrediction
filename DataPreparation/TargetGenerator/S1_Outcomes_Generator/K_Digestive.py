...
################ ICD10: K00–K93                        ##################################################
target_code = 'K0'
target_date_f = [str(i) + '-0.0' for i in range(131552, 131695) if i%2==0]

################ Inflammatory bowel disease             ##################################################
################ ICD10: K50–K52                         ##################################################
target_code = 'K1'
target_date_f = [str(i) + '-0.0' for i in range(131626, 131631) if i%2==0]

################ Liver diseases                         ##################################################
################ ICD10: K70–K77                    ##################################################
target_code = 'K2'
target_date_f = [str(i) + '-0.0' for i in range(131658, 131673) if i%2==0]

'''

target_code = 'K3'
target_date_f = [str(i) + '-0.0' for i in range(131682, 131683) if i%2==0]
