...
################ ICD10: M00-M99                              ##################################################
target_code = 'M0'
target_date_f = [str(i) + '-0.0' for i in range(131840, 131997) if i%2==0]

################ Osteoarthritis                               ##################################################
################ ICD10: M15–M19                               ##################################################
target_code = 'M1'
target_date_f = [str(i) + '-0.0' for i in range(131868, 131877) if i%2==0]

'''

target_code = 'M4'
target_date_f = [str(i) + '-0.0' for i in range(131930, 131961) if i%2==0]
