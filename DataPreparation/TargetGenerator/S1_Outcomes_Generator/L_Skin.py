...
################ ICD10: L00-L99                             ##################################################
target_code = 'L0'
target_date_f = [str(i) + '-0.0' for i in range(131696, 131839) if i%2==0]

'''
target_code = 'L1'
target_date_f = [str(i) + '-0.0' for i in range(131696, 131709) if i%2==0] + [str(i) + '-0.0' for i in range(131720, 131741) if i%2==0]
