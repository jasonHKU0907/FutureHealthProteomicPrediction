...
################ ICD10: A01-B89           ##################################################
target_code = 'A0'
target_date_f = [str(i) + '-0.0' for i in range(130002, 130327) if i%2==0]

################ Bacterial infections     ##################################################
################ ICD10: A01-A79           ##################################################
target_code = 'A1'
target_date_f = [str(i) + '-0.0' for i in range(130002, 130133) if i%2==0]

################ Viral infections     ##################################################
################ ICD10: A80-B34           ##################################################
target_code = 'A2'
target_date_f = [str(i) + '-0.0' for i in range(130134, 130225) if i%2==0]
'''
