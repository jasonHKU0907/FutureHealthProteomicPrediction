...
################ ICD10: G00–G99                   ##################################################
target_code = 'G0'
target_date_f = [str(i) + '-0.0' for i in range(130992, 131127) if i%2==0]

################ Parkinson disease                ##################################################
################ ICD10: G20-G22                   ##################################################
target_code = 'G1'
target_date_f = [str(i) + '-0.0' for i in range(131022, 131027) if i%2==0]

################ Sleep disorders                  ##################################################
################ ICD10: G47                       ##################################################
target_code = 'G2'
target_date_f = [str(i) + '-0.0' for i in range(131060, 131061) if i%2==0]
'''
