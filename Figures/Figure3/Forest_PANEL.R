...
mydata = read.csv('Data/PANELProRS.csv')
...
mydata[,c(2)] = paste(rep(" ", 32), collapse = " ")
...
p <- forest(mydata[, c(2, 3)],
            ...
            ref_line = 0,
            xlim = c(-0.11, 0.07),
            ticks_at = c(-0.1, -0.05, 0, 0.05),
            vert_line = c(-0.05, 0.05),
            theme = tm
            )


fontface = bg_font_lst
