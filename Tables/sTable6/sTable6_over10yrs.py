...
outpath1 = '/Volumes/JasonWork/Projects/UKB_Proteomics/Results/SuppData/sTables/sTable6/Data/OVER10YEARS/'
...
for target_code in target_code_lst:
    ...
    for fold_id in fold_id_lst:
        try:
            ...
            rm_idx = tmpdf.index[(tmpdf.Y_yrs <= 10) & (tmpdf.Y == 1)]
            tmpdf.drop(rm_idx, inplace=True)
